	...
	if(! $conn )
{
	...
	$sql = "UPDATE users 
       SET email =  IFNULL(NULLIF('$email',''),email),
	   uid = IFNULL(NULLIF('$uid',''),uid) 
...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="addmoney.php"><i class="fa fa-table fa-fw"></i> Add money</a>
                    </li>
                </ul>
                <!-- /#side-menu -->
            </div>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">User Profile for <?php print nl2br($_SESSION['username']); ?></h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
	  ...
	  <div class="col-lg-6">
	    <div class="input-group has-feedback">
		  <span class="input-group-addon"> New Email</span>
	  	  <input type="text" name="email" id="email "class="form-control" placeholder=" <?php print nl2br($info['email']); ?>">
	...
	<div class="row">
	  <div class="col-lg-6">
	    <div class="input-group has-feedback">
		  <span class="input-group-addon">New UID</span>
	  	  <input type="text" name="uid" id="uid" class="form-control" placeholder=" <?php print nl2br($info['uid']); ?>">
	      <span class="input-group-btn">
	      </span>
	    </div><!-- /input-group -->
	  </div><!-- /.col-lg-6 -->
	...
	<br>
	 ...
	 <input type="submit" name="update" class="btn btn-success" id="update" value="Submit changes" />
    </form>
